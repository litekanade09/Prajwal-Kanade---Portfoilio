                    ...
                    <div className="md:col-span-7">
                        <div className="text-lg text-muted-foreground max-w-[450px]">
                            ...
                            <p className="mt-3 slide-up-and-fade">
                                I possess a strong foundation in data structures, algorithms, and system design, allowing me to optimize performance and solve complex technical challenges across the entire stack. My focus is on delivering reliable, maintainable, and highly responsive digital solutions that drive efficiency and enhance user engagement.
                            </p>
                        </div>
                    </div>
                </div>
